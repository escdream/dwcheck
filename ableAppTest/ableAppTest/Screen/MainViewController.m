...
//        UserInfoViewController * userView = [[UserInfoViewController alloc] initWithNibName:@"UserInfoViewController" bundle:nil];

//        self.leftViewController = userView ;//[LeftViewController new];
        
        self.rightViewController = [RightViewController new];

        self.leftViewWidth = 300.0;
