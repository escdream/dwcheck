...
- (void)viewDidLoad {
    ...
    self.bacgroundImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"imageLeft"]];
    self.bacgroundImage.contentMode = UIViewContentModeScaleToFill;
    self.bacgroundImage.clipsToBounds = YES;
    
    self.bacgroundImage.frame = CGRectMake(0, 20, self.view.frame.size.width, self.view.frame.size.height);
